...
public class LoggedInActivity_debug extends AppCompatActivity {
    ...
    @Bind(R.id.pasted) TextView pView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _outBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                final AlertDialog.Builder builder = new AlertDialog.Builder(LoggedInActivity_debug.this,
                        R.style.AppTheme_Light_Dialog);
                builder.setTitle("Re-enter password:");

                final EditText confirm = new EditText(LoggedInActivity_debug.this);
